  public class Veriable  {
 	public static void main(String[] args) {
		...
		int typeSystem = 64; /*  - разрядная система */
   		float locDiskRsrvd = 70.7F; /* занято дисковой памяти */
    	long totalMind = 239215648768L; /* емкость диска в байтах */
        ...
        System.out.print(markaPc);
 		...
 		System.out.println(locDiskRsrvd);
        System.out.print("Общая память  - ");
        System.out.print(totalMind);
